...
coordinates_shaft_cell = cell(total_number_release, 1);
row_id_leave_string_shaft_array = zeros(total_number_release,1);
...
for vel_id=1:2
    ...
    for release_number = 1:10
        ...
        coordinates_shaft_cell{release_number} = coordinates_shaft;
        row_id_leave_string_shaft_array(release_number) = row_id_leave_string_shaft;
        ...
        t_acce = coordinates_shaft(20:end,3);
        data_acce = coordinates_shaft(20:end,vel_id);
        ...
        if copy_num == 0
            ...
            hold on
            figure(3)
            plot(t_acce, acce, 'r.', time, y_fit,'r-', 'MarkerSize', 12);
...
disp([velocities, average_angles])
